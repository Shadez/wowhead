...
define('ITEM_SUBCLASS_SOUL_CONTAINER', 1);
define('ITEM_SUBCLASS_HERB_CONTAINER', 2);
define('ITEM_SUBCLASS_ENCHANTING_CONTAINER', 3);
define('ITEM_SUBCLASS_ENGINEERING_CONTAINER', 4);
define('ITEM_SUBCLASS_GEM_CONTAINER', 5);
define('ITEM_SUBCLASS_MINING_CONTAINER', 6);
define('ITEM_SUBCLASS_LEATHERWORKING_CONTAINER', 7);
define('ITEM_SUBCLASS_INSCRIPTION_CONTAINER', 8);
...
define('ITEM_SUBCLASS_GEM_RED', 0);
define('ITEM_SUBCLASS_GEM_BLUE', 1);
define('ITEM_SUBCLASS_GEM_YELLOW', 2);
define('ITEM_SUBCLASS_GEM_PURPLE', 3);
define('ITEM_SUBCLASS_GEM_GREEN', 4);
define('ITEM_SUBCLASS_GEM_ORANGE', 5);
define('ITEM_SUBCLASS_GEM_META', 6);
define('ITEM_SUBCLASS_GEM_SIMPLE', 7);
define('ITEM_SUBCLASS_GEM_PRISMATIC', 8);
...
define('ITEM_SUBCLASS_WAND', 0); // ABS
define('ITEM_SUBCLASS_BOLT', 1); // ABS
define('ITEM_SUBCLASS_ARROW', 2);
define('ITEM_SUBCLASS_BULLET', 3);
define('ITEM_SUBCLASS_THROWN', 4); // ABS

define('MAX_ITEM_SUBCLASS_PROJECTILE', 5);

//enum ItemSubclassTradeGoods
define('ITEM_SUBCLASS_TRADE_GOODS', 0);
define('ITEM_SUBCLASS_PARTS', 1);
define('ITEM_SUBCLASS_EXPLOSIVES', 2);
define('ITEM_SUBCLASS_DEVICES', 3);
define('ITEM_SUBCLASS_JEWELCRAFTING', 4);
define('ITEM_SUBCLASS_CLOTH', 5);
define('ITEM_SUBCLASS_LEATHER', 6);
define('ITEM_SUBCLASS_METAL_STONE', 7);
define('ITEM_SUBCLASS_MEAT', 8);
define('ITEM_SUBCLASS_HERB', 9);
define('ITEM_SUBCLASS_ELEMENTAL', 10);
define('ITEM_SUBCLASS_TRADE_GOODS_OTHER', 11);
define('ITEM_SUBCLASS_ENCHANTING', 12);
define('ITEM_SUBCLASS_MATERIAL', 13);
define('ITEM_SUBCLASS_ARMOR_ENCHANTMENT', 14);
define('ITEM_SUBCLASS_WEAPON_ENCHANTMENT', 15);

define('MAX_ITEM_SUBCLASS_TRADE_GOODS', 16);

//enum ItemSubclassGeneric
define('ITEM_SUBCLASS_GENERIC', 0);

define('MAX_ITEM_SUBCLASS_GENERIC', 1);

//enum ItemSubclassRecipe
define('ITEM_SUBCLASS_BOOK', 0);
define('ITEM_SUBCLASS_LEATHERWORKING_PATTERN', 1);
define('ITEM_SUBCLASS_TAILORING_PATTERN', 2);
define('ITEM_SUBCLASS_ENGINEERING_SCHEMATIC', 3);
define('ITEM_SUBCLASS_BLACKSMITHING', 4);
define('ITEM_SUBCLASS_COOKING_RECIPE', 5);
define('ITEM_SUBCLASS_ALCHEMY_RECIPE', 6);
define('ITEM_SUBCLASS_FIRST_AID_MANUAL', 7);
define('ITEM_SUBCLASS_ENCHANTING_FORMULA', 8);
define('ITEM_SUBCLASS_FISHING_MANUAL', 9);
define('ITEM_SUBCLASS_JEWELCRAFTING_RECIPE', 10);
...
define('ITEM_SUBCLASS_QUIVER0', 0); // ABS
define('ITEM_SUBCLASS_QUIVER1', 1); // ABS
define('ITEM_SUBCLASS_QUIVER', 2);
define('ITEM_SUBCLASS_AMMO_POUCH', 3);
...
define('ITEM_SUBCLASS_JUNK_REAGENT', 1);
define('ITEM_SUBCLASS_JUNK_PET', 2);
define('ITEM_SUBCLASS_JUNK_HOLIDAY', 3);
define('ITEM_SUBCLASS_JUNK_OTHER', 4);
define('ITEM_SUBCLASS_JUNK_MOUNT', 5);

define('MAX_ITEM_SUBCLASS_JUNK', 6);

//enum ItemSubclassGlyph
define('ITEM_SUBCLASS_GLYPH_WARRIOR', 1);
define('ITEM_SUBCLASS_GLYPH_PALADIN', 2);
define('ITEM_SUBCLASS_GLYPH_HUNTER', 3);
define('ITEM_SUBCLASS_GLYPH_ROGUE', 4);
define('ITEM_SUBCLASS_GLYPH_PRIEST', 5);
define('ITEM_SUBCLASS_GLYPH_DEATH_KNIGHT', 6);
define('ITEM_SUBCLASS_GLYPH_SHAMAN', 7);
define('ITEM_SUBCLASS_GLYPH_MAGE', 8);
define('ITEM_SUBCLASS_GLYPH_WARLOCK', 9);
define('ITEM_SUBCLASS_GLYPH_DRUID', 11);
...
define('LOCALE_ES', 6);
define('LOCALE_FR', 2);
define('LOCALE_RU', 8); // 7 in global.js // already 8 (need to check)
...
define('ACHIEVEMENT_CRITERIA_TYPE_HIGHEST_PERSONAL_RATING', 39);
...
define('ACHIEVEMENT_CRITERIA_TYPE_EARN_ACHIEVEMENT_POINTS', 115);
